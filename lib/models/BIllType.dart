...
List<BillType> billTypeFromJson(String str) => List<BillType>.from(json.decode(str).map((x) => BillType.fromJson(x)));

String billTypeToJson(List<BillType> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
