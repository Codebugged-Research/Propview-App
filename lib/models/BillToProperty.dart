...
List<BillToProperty> billToPropertyFromJson(String str) => List<BillToProperty>.from(json.decode(str).map((x) => BillToProperty.fromJson(x)));

String billToPropertyToJson(List<BillToProperty> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
