...
List<RegularInspection> regularInspectionFromJson(String str) => List<RegularInspection>.from(json.decode(str).map((x) => RegularInspection.fromJson(x)));

String regularInspectionToJson(List<RegularInspection> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RegularInspection {
  ...
  factory RegularInspection.fromJson(Map<String, dynamic> json) => RegularInspection(
