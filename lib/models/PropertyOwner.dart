...
PropertyOwner propertyOwnerFromJson(String str) =>
    PropertyOwner.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        propertyOwner: json["propertyOwner"] == null
            ? null
            : List<PropertyOwnerElement>.from(json["propertyOwner"]
                .map((x) => PropertyOwnerElement.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "propertyOwner": propertyOwner == null
            ? null
            : List<dynamic>.from(propertyOwner.map((x) => x.toJson())),
      };
}
...
class PropertyOwnerElement {
  ...
  factory PropertyOwnerElement.fromJson(Map<String, dynamic> json) =>
      PropertyOwnerElement(
        ...
        ownerAddress:
            json["owner_address"] == null ? null : json["owner_address"],
        ownerPassword:
            json["owner_password"] == null ? null : json["owner_password"],
        ownerName1: json["owner_name1"] == null ? null : json["owner_name1"],
        ownerEmail1: json["owner_email1"] == null ? null : json["owner_email1"],
        ownerNumber1:
            json["owner_number1"] == null ? null : json["owner_number1"],
