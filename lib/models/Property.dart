...
class PropertyElement {
  ...
  factory PropertyElement.fromJson(Map<String, dynamic> json) =>
      PropertyElement(
        tableproperty: json["tableproperty"] == null
            ? null
            : Tableproperty.fromJson(json["tableproperty"]),
        propertyOwner: json["property_owner"] == null
            ? null
            : PropertyOwnerElement.fromJson(json["property_owner"]),
        tblCountry: json["tbl_country"] == null
            ? null
            : TblCountry.fromJson(json["tbl_country"]),
        tblState: json["tbl_state"] == null
            ? null
            : TblState.fromJson(json["tbl_state"]),
        tblCity: json["tbl_city"] == null
            ? null
            : TblCity.fromJson(json["tbl_city"]),
        tblLocality: json["tbl_locality"] == null
            ? null
            : TblLocality.fromJson(json["tbl_locality"]),
        tblSociety: json["tbl_society"] == null
            ? null
            : TblSociety.fromJson(json["tbl_society"]),
      );
...
class Tableproperty {
  ...
  String inactiveDate;
  String vacatingDate;
  String firstInspection;
  String qtr1Inspection;
  String qtr2Inspection;
  String qtr3Inspection;
  String qtr4Inspection;
  ...
  factory Tableproperty.fromJson(Map<String, dynamic> json) => Tableproperty(
        ...
        propertyKind:
            json["property_kind"] == null ? null : json["property_kind"],
        ownerId: json["owner_id"] == null ? null : json["owner_id"],
        flagCategoryId:
            json["flag_category_id"] == null ? null : json["flag_category_id"],
        ...
        maintenanceType:
            json["maintenance_type"] == null ? null : json["maintenance_type"],
        securityDeposit:
        ...
        superArea: json["super_area"] == null
            ? 0.0
            : double.parse(json["super_area"].toString()),
        ...
        carpetPrefix:
            json["carpet_prefix"] == null ? null : json["carpet_prefix"],
        ...
        parkingCovered:
            json["parking_covered"] == null ? null : json["parking_covered"],
        powerBackup: json["power_backup"] == null ? null : json["power_backup"],
        visitingHoursFrom: json["visiting_hours_from"] == null
            ? null
            : json["visiting_hours_from"],
        visitingHoursFromPrefix: json["visiting_hours_from_prefix"] == null
            ? null
            : json["visiting_hours_from_prefix"],
        visitingHoursTo: json["visiting_hours_to"] == null
            ? null
            : json["visiting_hours_to"],
        visitingHoursToPrefix: json["visiting_hours_to_prefix"] == null
            ? null
            : json["visiting_hours_to_prefix"],
        visitingDays:
            json["visiting_days"] == null ? null : json["visiting_days"],
        ...
        mainDoorFacing:
            json["main_door_facing"] == null ? null : json["main_door_facing"],
        overlooking: json["overlooking"] == null ? null : json["overlooking"],
        balconyFacing:
            json["balcony_facing"] == null ? null : json["balcony_facing"],
        ...
        propertyDetail:
            json["property_detail"] == null ? null : json["property_detail"],
        propertyDetailId: json["property_detail_id"] == null
            ? null
            : json["property_detail_id"],
        ...
        rentDate: json["rent_date"] == null
            ? null
            : DateTime.parse(json["rent_date"]),
        rentRenewalDate: json["rent_renewal_date"] == null
            ? null
            : DateTime.parse(json["rent_renewal_date"]),
        inactiveDate:
            json["inactive_date"] == null ? null : json["inactive_date"],
        vacatingDate:
            json["vacating_date"] == null ? null : json["vacating_date"],
        firstInspection:
            json["first_inspection"] == null ? null : json["first_inspection"],
        qtr1Inspection:
            json["qtr1_inspection"] == null ? null : json["qtr1_inspection"],
        qtr2Inspection:
            json["qtr2_inspection"] == null ? null : json["qtr2_inspection"],
        qtr3Inspection:
            json["qtr3_inspection"] == null ? null : json["qtr3_inspection"],
        qtr4Inspection:
            json["qtr4_inspection"] == null ? null : json["qtr4_inspection"],
        rentPaymentMethod: json["rent_payment_method"] == null
            ? null
            : json["rent_payment_method"],
        rentInstructions: json["rent_instructions"] == null
            ? null
            : json["rent_instructions"],
        generalInstructions: json["general_instructions"] == null
            ? null
            : json["general_instructions"],
        keyInventory:
            json["key_inventory"] == null ? null : json["key_inventory"],
        brokerName: json["broker_name"] == null ? null : json["broker_name"],
        lastInspection:
            json["last_inspection"] == null ? null : json["last_inspection"],
        nextInspection:
            json["next_inspection"] == null ? null : json["next_inspection"],
        constructionAge:
            json["construction_age"] == null ? null : json["construction_age"],
        additionalInformation: json["additional_information"] == null
            ? null
            : json["additional_information"],
        moreInformation:
            json["more_information"] == null ? null : json["more_information"],
        plotArea: json["plot_area"] == null ? null : json["plot_area"],
        plotAreaPrefix:
            json["plot_area_prefix"] == null ? null : json["plot_area_prefix"],
        builtupArea: json["builtup_area"] == null
            ? null
            : json["builtup_area"].toDouble(),
        builtupAreaPrefix: json["builtup_area_prefix"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
        ...
        "visiting_hours_from":
            visitingHoursFrom == null ? null : visitingHoursFrom,
        "visiting_hours_from_prefix":
            visitingHoursFromPrefix == null ? null : visitingHoursFromPrefix,
        "visiting_hours_to": visitingHoursTo == null ? null : visitingHoursTo,
        "visiting_hours_to_prefix":
            visitingHoursToPrefix == null ? null : visitingHoursToPrefix,
        ...
        "property_detail_id":
            propertyDetailId == null ? null : propertyDetailId,
        ...
        "rent_renewal_date":
            rentRenewalDate == null ? null : rentRenewalDate.toIso8601String(),
        "inactive_date": inactiveDate == null ? null : inactiveDate,
        "vacating_date": vacatingDate == null ? null : vacatingDate,
        "first_inspection": firstInspection == null ? null : firstInspection,
        "qtr1_inspection": qtr1Inspection == null ? null : qtr1Inspection,
        "qtr2_inspection": qtr2Inspection == null ? null : qtr2Inspection,
        "qtr3_inspection": qtr3Inspection == null ? null : qtr3Inspection,
        "qtr4_inspection": qtr4Inspection == null ? null : qtr4Inspection,
        "rent_payment_method":
            rentPaymentMethod == null ? null : rentPaymentMethod,
        "rent_instructions": rentInstructions == null ? null : rentInstructions,
        "general_instructions":
            generalInstructions == null ? null : generalInstructions,
        "key_inventory": keyInventory == null ? null : keyInventory,
        "broker_name": brokerName == null ? null : brokerName,
        "last_inspection": lastInspection == null ? null : lastInspection,
        "next_inspection": nextInspection == null ? null : nextInspection,
...
class TblSociety {
  ...
  factory TblSociety.fromJson(Map<String, dynamic> json) => TblSociety(
        ...
        societyFacility:
            json["society_facility"] == null ? null : json["society_facility"],
        ...
        maintenanceCompany: json["maintenance_company"] == null
            ? null
            : json["maintenance_company"],
        ...
        rateAuthority:
            json["rate_authority"] == null ? null : json["rate_authority"],
        ratePowerbackup:
            json["rate_powerbackup"] == null ? null : json["rate_powerbackup"],
        waterCharges:
            json["water_charges"] == null ? null : json["water_charges"],
        maintenanceCommon: json["maintenance_common"] == null
            ? null
            : json["maintenance_common"],
        electricityCommon: json["electricity_common"] == null
            ? null
            : json["electricity_common"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "maintenance_company":
            maintenanceCompany == null ? null : maintenanceCompany,
        ...
        "maintenance_common":
            maintenanceCommon == null ? null : maintenanceCommon,
        "electricity_common":
            electricityCommon == null ? null : electricityCommon,
