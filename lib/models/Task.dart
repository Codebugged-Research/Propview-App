...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        task: json["task"] == null
            ? null
            : List<TaskElement>.from(
                json["task"].map((x) => TaskElement.fromJson(x))),
      );
...
class TaskElement {
  ...
  factory TaskElement.fromJson(Map<String, dynamic> json) => TaskElement(
        ...
        propertyOwnerRef: json["property_owner_ref"] == null
            ? null
            : json["property_owner_ref"],
        property: json["tableproperty"] == null
            ? null
            : Tableproperty.fromJson(json["tableproperty"]),
        tblUsers: json["tbl_users"] == null
            ? null
            : TblUsers.fromJson(json["tbl_users"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "property_owner_ref":
            propertyOwnerRef == null ? null : propertyOwnerRef,
